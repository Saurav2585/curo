...
/** Relative day label in the clinic's zone — "Today", "Tomorrow", "In 3 days",
 *  "Yesterday", "5 days ago". Presentation only; the absolute date stays. */
    ...
    return (
      ...
      >
        <div className="flex items-start justify-between gap-4">
          ...
          {/* Right column: status on top, action beneath — balances the card */}
    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-6 py-14">
        ...
        {bookings.length === 0 ? (
          ...
          <div className="mt-8 rounded-[var(--radius-lg)] border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-12 text-center">
            <span
            ...
            {upcoming.length > 0 && (
              <section>
                <h2 className="mb-4 flex items-center gap-2 text-[0.8125rem] font-semibold uppercase tracking-[0.06em] text-[var(--text-muted)]">
                  Upcoming
                  <span className="tabular font-normal text-[var(--text-disabled)]">
                    {upcoming.length}
                  </span>
                </h2>
